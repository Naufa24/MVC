		...
		<div class="col-lg-6">
			<h2>Daftar Mahasiswa</h2>
					<ul class="list-group">
						...
						<a href="<?= BASEURL;?>/mahasiswa/ubah/<?= $mhs['id']; ?>" class="badge text-bg-success float-end m-1 tampilModalUbah" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $mhs['id']; ?>">edit</a>
      	...
      	<form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
			...
			<div class="form-group">
				...
				<select class="form-control" id="jurusan" name="jurusan">
					...
					<option value="Teknik Sepedah Motor">Teknik Sepedah Motor</option>
